...
@Entity
@Table(name = "child_entity", schema = "transactions")
@SequenceGenerator(
        name = "child_entity_seq_tx",
        sequenceName = "child_entity_seq_tx",
        schema = "transactions",
        allocationSize = 1
)
public class ChildEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "child_entity_seq_tx")
    @Column(name = "id")
    private int id;
