...
@Entity
@Table(name = "parent_entity", schema = "performance")
@SequenceGenerator(
        name = "parent_entity_seq_pf",
        sequenceName = "parent_entity_seq_pf",
        schema = "performance",
        allocationSize = 1
)
public class ParentEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "parent_entity_seq_pf")
    @Column(name = "id")
    private int id;
